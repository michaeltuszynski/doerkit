...
The parts of this design are all commercially proven somewhere. Embedded practice exists at publisher scale. Instant AI feedback on written answers exists as a teacher tool. Spaced review exists in every flashcard app. The combination — rubric-graded writing inside the reading flow, with cumulative spaced review, and a grader you can actually trust — is open territory. So is the engineering discipline underneath it.
